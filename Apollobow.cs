...
namespace darkolympus.Apollobow
{
    public class Apollobow : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Apollo, god of archery, the sun and music. With this enchanted bow may you strike down your enimies with the power of the sun in your in your hands.");
        }
...

        {
            ...
            {
                type = mod.ProjectileType("godarrow"); // or ProjectileID.FireArrow;
            }
        }
