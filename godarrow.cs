...
{
	public class godarrow : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("God arrow");     //The English name of the projectile
		...
		public override void SetDefaults() {
			...
			aiType = AmmoID.Arrow;           //Act exactly like default Bullet
		}
